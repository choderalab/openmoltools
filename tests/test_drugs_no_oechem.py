...
def test_drugs():
    ...
    if os.environ.get("TRAVIS", None) == 'true':
        ...
        CHARGE_MODEL = None  # Travis is actually too slow to do a single calculation!
    ...
    for k in range(n_molecules):
        ...
        with utils.enter_temp_directory():
            yield utils.tag_description(lambda : utils.test_molecule("LIG", mol2_filename, charge_model=CHARGE_MODEL), "Testing drugs %s" % molecule_name)
