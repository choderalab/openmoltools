...
prmtop = app.AmberPrmtopFile("./examples/etoh/etoh.prmtop")
inpcrt = app.AmberInpcrdFile("./examples/etoh/etoh.inpcrd")

system_prm = prmtop.createSystem(nonbondedMethod=app.NoCutoff, nonbondedCutoff=1.0*u.nanometers, constraints=None)

mol2 = gafftools.Mol2Parser("./examples/etoh/etoh.mol2")
top, xyz = mol2.to_openmm()

forcefield = app.ForceField("./examples/etoh/etoh.xml")
