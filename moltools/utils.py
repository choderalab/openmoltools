...
from moltools import amber_parser, system_checker
...
def get_data_filename(relative_path):
    ...
    In the source distribution, these files are in ``moltools/chemicals/*/``,
    ...
    ----------
    name : str
        Name of the file to load (with respect to the moltools folder).

    """

    fn = resource_filename('moltools', relative_path)
...
def molecule_to_mol2(*args, **kwargs):
    print("Warning: molecule_to_mol2 has been moved to moltools.openeye.")
    import moltools.openeye 
    return moltools.openeye.molecule_to_mol2(*args, **kwargs)
